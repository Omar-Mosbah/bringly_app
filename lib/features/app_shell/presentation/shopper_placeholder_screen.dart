...
/// Phase 1 placeholder screen for the Shopper primary tab.
///
/// Shows safe copy about upcoming shopper features.
/// No backend calls, no storage writes, no analytics events.
class ShopperPlaceholderScreen extends StatelessWidget {
  const ShopperPlaceholderScreen({super.key});
